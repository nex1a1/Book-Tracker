...
export const Icons = {
  ...
  Star: ({ filled, half, id = Math.random().toString(36).substring(2, 11) }: StarIconProps) => (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      {half && <clipPath id={`half-${id}`}><rect x="0" y="0" width="12" height="24" /></clipPath>}
  ...
  Pause: () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="6" y="4" width="4" height="16"></rect><rect x="14" y="4" width="4" height="16"></rect></svg>,
};
